...
echo ""
echo "========================================="
echo "  Installation Complete! v1.1.0"
echo "  NVIDIA Broadcast for Linux"
echo "  by doczeus | AI Powered"
echo "========================================="
echo ""
...
echo "    Eye Contact Correction   — gaze redirection to camera"
echo "    Face Relighting          — AI-powered lighting adjustment"
echo "    Session Recording        — record processed video to file"
echo "    User Profiles            — save/load per-user settings"
echo ""
