...
in
{
  options.programs.nvbroadcast = {
    ...
    package = lib.mkOption {
      ...
      default = package;
      defaultText = lib.literalExpression "inputs.nvbroadcast.packages.x86_64-linux.nvbroadcast";
      description = "The nvbroadcast package to install.";
    };
    ...
    nvidia.enable = lib.mkOption {
      ...
      default = false;
      example = true;
      description = "Whether to enable basic NVIDIA driver defaults for nvbroadcast.";
    };
    ...
    v4l2loopback = {
      enable = lib.mkOption {
        ...
        default = true;
        example = false;
        description = "Whether to load and configure v4l2loopback for nvbroadcast virtual camera output.";
      };
      ...
      videoNr = lib.mkOption {
        ...
        default = 10;
        example = 42;
        description = "Video device number for the v4l2loopback output device.";
      };
      ...
      cardLabel = lib.mkOption {
        ...
        description = "Label for the v4l2loopback output device.";
      };
      ...
      exclusiveCaps = lib.mkOption {
        ...
        default = true;
        example = false;
        description = "Whether to enable exclusive capabilities for the v4l2loopback output device.";
      };
      ...
      maxBuffers = lib.mkOption {
        ...
        default = 4;
        example = 8;
        description = "Maximum number of buffers for the v4l2loopback output device.";
      };
    };
  };
    ...
    assertions = [
      {
        ...
        message = "programs.nvbroadcast currently supports only x86_64-linux";
      }
    ];
