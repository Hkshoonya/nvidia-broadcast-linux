...
- **Lower Replacement Processing Cost** - Background replacement reuses mask tone curves, limits edge and color cleanup to relevant pixels, and avoids returning unused model output while retaining camera resolution and per-frame inference.
